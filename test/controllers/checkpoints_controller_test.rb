...
class CheckpointsControllerTest < ActionController::TestCase
  ...
  test "should create checkpoint" do
    assert_difference('Checkpoint.count') do
      post :create, checkpoint: { date: @checkpoint.date, roll_call: @checkpoint.roll_call, stayed_clean: @checkpoint.stayed_clean, submitted_roll_call: @checkpoint.submitted_roll_call }
    end
  ...
  test "should update checkpoint" do
    patch :update, id: @checkpoint, checkpoint: { date: @checkpoint.date, roll_call: @checkpoint.roll_call, stayed_clean: @checkpoint.stayed_clean, submitted_roll_call: @checkpoint.submitted_roll_call }
    assert_redirected_to checkpoint_path(assigns(:checkpoint))
  end
